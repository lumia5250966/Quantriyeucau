    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title" style="float: left">Danh sách cấu hình hệ thống</h3>
                <a class="btn btn-default" style="float: right" id="addConfig"> <i class="fa fa-plus"></i> Thêm mới cấu hình</a>
            </div>
            <div class="box-body">
            ...
            <div class="modal-body row">
                <div class="col-md-12 col-xs-12 row">
                    <div class="col-md-12 col-xs-12">
                        <label for="config_name">Tên cấu hình <span style="color: red">*</span> </label>
                ...
                <div class="col-md-12 col-xs-12 row" style="margin-top: 10px">
                    <div class="col-md-12 col-xs-12">
                        <label for="config_value">Giá trị cấu hình <span style="color: red">*</span> </label>
                        <input class="form-control" id="config_value" name="config_value" placeholder="..." type="text">
                    </div>
                </div>
                <div class="col-md-12 col-xs-12 row" style="margin-top: 10px">
                    <div class="col-md-12 col-xs-12">
        ...
        function editConfig(id){
            ...
            _data.forEach(function(item){
                if(id == item.config_id){
                    ...
                    $("#config_dateapply").val(moment(item.config_dateapply, "YYYY-MM-DD").function( ) {}ormat("DD/MM/YYYY"));
                    $("#ActionModule").modal("show");
                }
            })
